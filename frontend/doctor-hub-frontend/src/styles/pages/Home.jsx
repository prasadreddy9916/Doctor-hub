...
const stats = [
  { n: "12K+", l: "Doctors learning" },
  { n: "850+", l: "Video lessons" },
  { n: "120+", l: "Live seminars" },
  { n: "30+", l: "Specializations" },
];

export default function Home() {
  const reasons = [
    { icon: <Users />, title: "Built for doctors", desc: "Designed specifically for medical professionals.", color: "blue" },
    { icon: <Globe />, title: "All specializations", desc: "Cardiology, neurology, orthopedics & more." , variant: "blue" },
    { icon: <BookOpen />, title: "Anywhere, anytime", desc: "Mobile-first learning that fits your schedule.", variant: "blue"  },
    { icon: <Sparkles />, title: "Simple & intuitive", desc: "Clean interface focused on your learning." , variant: "blue" },
  ];
  return (
    <>
          ...
          <div className="animate-fade-up">
            ...
            <div className="flex items-center gap-6 mt-10">
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">Trusted by 12,000+ doctors</div>
              </div>
            </div>
          </div>
      ...
      <section className="section !py-12">
        <div className="container-x grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map(s => (
            <div key={s.l} className="feature-card text-center">
        ...
        <div className="container-x grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-5">
              {reasons.map(r => (
                <div key={r.title} className="flex gap-4 colored-icon">
                  <div className="w-12 h-12 rounded-2xl gradient-hero text-red flex items-center justify-center shrink-0">{r.icon}</div>
                  <div>
